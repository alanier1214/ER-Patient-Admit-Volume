"""
ED Volume Forecasting — Model Training
=======================================
Trains two XGBoost models:
    Stage 1: Predict total ED encounters from time-based features
    Stage 2: Predict total admissions from time features + predicted encounters

Saves:
    xgb_encounter_forecast.pkl
    xgb_admissions_forecast.pkl
    agg_data.pkl                  — Aggregated dataset used for training (needed by forecast script)
"""
...
if __name__ == "__main__":
    ...
    joblib.dump(model_enc, "xgb_encounter_forecast.pkl")
    print("Saved: xgb_encounter_forecast.pkl")
    ...
    joblib.dump(model_adm, "xgb_admissions_forecast.pkl")
    print("Saved: xgb_admissions_forecast.pkl")

    # Save aggregated dataset for use in forecast script
    joblib.dump(agg, "agg_data.pkl")
    print("Saved: agg_data.pkl")
